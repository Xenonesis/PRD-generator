  ...
  return (
    <>
      <div 
        ...
        onClick={onClose}
      />
      <div className="fixed inset-y-0 right-0 z-50 w-80 bg-white dark:bg-[#1A1A1A] border-l border-black/10 dark:border-white/10 shadow-2xl flex flex-col transform transition-transform animate-fade-in text-[#1A1A1A] dark:text-[#F4F1EE]">
